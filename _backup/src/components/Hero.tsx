    ...
    <section className="relative pt-40 pb-24 overflow-hidden bg-white">
      <div className="container flex flex-col items-center text-center">
        <motion.div 
          ...
          className="max-w-4xl"
        >
          <h1 className="text-6xl md:text-7xl lg:text-[6.5rem] leading-[1.05] mb-10 text-primary">
            An Individual Approach <br />
            To Beauty & <br />
            <span className="font-serif italic text-secondary">Healthy Smiles</span>
          </h1>
          <p className="text-xl text-slate-500 mb-12 max-w-2xl mx-auto leading-relaxed">
            Strengthening your confidence through comfortable, personalized treatments. 
            Experience premium dental care led by Dr. Salome Tsiskarava.
          </p>
